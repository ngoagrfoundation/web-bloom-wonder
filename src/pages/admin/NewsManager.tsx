...
const emptyArticle: NewsArticle = { slug: "", title: "", excerpt: "", content: "", image: "", author: "AGR Foundation", category: "announcement", read_time: 3, is_published: 1 };
...
const NewsManager = () => {
  ...
  const fetchData = async () => { const result = await getNews(); if (result.data) setArticles(result.data); setLoading(false); };
  useEffect(() => { fetchData(); }, []);
